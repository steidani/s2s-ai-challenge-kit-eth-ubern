...
#lead_time = 0#hind_2000_2019.lead_time[0]
#lead_output = 0#obs_2000_2019.lead_time[0]
        ...
        def train_patch(fct_train_patch, verif_train_patch, basis, clim_probs, bs, v):
        ...
        cnn = train_patch(fct_train_patch, verif_train_patch, basis, clim_probs, bs, v)
    
        cnn.save(f'CNN_patch_lead{lead_time}_{v}_{ep}')#creates a new folder with model details
        ...
        da.to_dataset(name = v).to_netcdf(f'../submissions/global_prediction_{v}_lead{lead_time}_raw_allyears.nc')
        ...
        da.to_dataset(name = v).to_netcdf(f'../submissions/global_prediction_{v}_lead{lead_time}_smooth_allyears.nc')
        ...
        da.to_dataset(name = v).to_netcdf(f'../submissions/global_prediction_{v}_lead{lead_time}_2020_raw.nc')
        ...
        da_smooth.to_dataset(name = v).to_netcdf(f'../submissions/global_prediction_{v}_lead{lead_time}_2020_smooth.nc')
