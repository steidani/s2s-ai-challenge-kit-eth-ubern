...
output_lats = [slice(63,52), slice(63,52),slice(63,52), slice(63,52)]#slice(90,0)]#8,8,8,8###,61
output_lons = [slice(67,78), slice(67,78), slice(67,78), slice(67,78)]#slice(0,90)]#7,7,7,7###,61
...
setup = pd.DataFrame(setup_params, columns = ['fold_no','output_lats', 'output_lons', 'input_lats', 'input_lons', 'radius_basis_func', 'number_basis_func','standardization', 'rm_annual_cycle', 'rm_tercile_edges', 'batch_size', 'epochs', 'features'])
