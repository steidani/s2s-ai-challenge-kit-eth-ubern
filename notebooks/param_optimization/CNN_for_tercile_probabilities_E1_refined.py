...
#old reference domain: input_lats = [ slice(81,34)], input_lons = [slice(49,97)]
input_lats = [slice(81,34),slice(81,34),slice(81,34),slice(81,34)]#[slice(60,55), slice(63,52),slice(69,46), slice(81,34)]
input_lons = [slice(1,97), slice(49,145), slice(25,121), slice(1,145)]#left, right, middle_small, middle_large#64,64,64,96##[slice(70,75), slice(67,78), slice(61,85), slice(49,97)]

output_lats = [slice(63,52), slice(63,52),slice(63,52), slice(63,52)]##8,8,8,8
...
results.to_csv('E1_refined_results_t2m_34_t2m.csv', sep =';', index = False)   
