...
for additional input domain sizes. 
This is an addition to E1, but now using label smoothing of 0.4 (and 0.6).
"""
...
input_lats = [slice(81,34),slice(81,34),slice(81,34),slice(81,34)]
input_lons = [slice(1,97), slice(49,145), slice(25,121), slice(1,145)]
