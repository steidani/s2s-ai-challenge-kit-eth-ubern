""" 
This script investigates the influence of the output domain size on model performance.
Jointly increase input and output domain, always size(input) = size (output).
"""
...
#results.to_csv('E2_results_t2m_34_t2m.csv', sep =';', index = False)