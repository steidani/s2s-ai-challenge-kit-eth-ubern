...
input_lats = [ slice(81,34)]#slice(63,52),slice(69,46),slice(80,20),slice(90,-90)]#, 8, 16, 32#[slice(81,34)]#
input_lons = [slice(49,97)]#slice(67,78), slice(61,85),slice(-60, 100), slice(-180,180)]# , slice(0, 360)]#[slice(49,97)]#
...
output_lats = [slice(63,52)]#, slice(63,52),slice(63,52),slice(63,52)]#, slice(63,52)]#slice(90,0)]#8,8,8,8###,61#[slice(63,52)]#
output_lons = [slice(67,78)]#, slice(67,78), slice(67,78), slice(67,78)]#, slice(67,78)]#slice(0,90)]#7,7,7,7###,61#[slice(67,78)]#
...
for i  in  range(0, len(input_lats)):
    ...
    rad = [8]#,8,8]#,8][8]#[8,8,8,8]#[4,6,7,10]
    basis_rad = rad[i]
